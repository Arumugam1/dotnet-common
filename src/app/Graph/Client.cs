...
namespace automation.core.components.data.v1.Graph
{
    public class Point
    {
...
namespace automation.core.components.data.v1.Graph.Providers
{
...
namespace automation.core.components.data.v1.Graph.Providers.Graphite
{
        ...
        public GraphProvider()
        {
            ...
            catch (Exception ex)
            {
                Trace.Exception(TraceTypes.AccessLayer,
                    "automation.core.components.data.v1.Graph.Providers.Graphite.GraphProvider",
                    "GraphProvider",
