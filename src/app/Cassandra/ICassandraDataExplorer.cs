...
{
    public interface ICassandraDataExplorer
    {
        bool Add<T>(string key, T value);
        bool Add<T>(string key, T value, uint timeToLive);
        bool Add<T>(DataExplorer<T>.Data data);
        bool Add<T>(DataExplorer<T>.Data data, uint timeToLive);
        bool Add<T>(List<DataExplorer<T>.Data> data);
        bool Add<T>(List<DataExplorer<T>.Data> data, uint timeToLive);

        T Get<T>(string key);
        T Get<T>(string key, bool executeInSingleNode);
        List<T> Get<T>(List<string> keys);
        List<T> Get<T>(List<string> keys, bool executeInSingleNode);
        List<string> GetKeys();
        List<T> Get<T>(int limit);
        ...
        T Get<T>(string columnFamily, string key);
        List<T> Get<T>(string columnFamily, List<string> keys);

        // Deprecated Methods
        T Get<T>(string key, int retryCount, bool resetDBConnection);
        T Get<T>(string columnFamily, string key, int retryCount, bool resetDBConnection);
        List<T> Get<T>(List<string> keys, int retryCount, bool resetDBConnection);
        List<T> Get<T>(string columnFamily, List<string> keys, int retryCount, bool resetDBConnection);
        ...
        List<T> GetAllRows<T>(string columnFamily, int limit);

        List<T> GetAllRows<T>(string columnFamily, List<string> requestColumn, int limit);
        ...
        List<T> ExecuteQueryForSOLR<T>(string columnFamily, List<string> requestColumn,
        ...
        List<T> GetIndexes<T>(string columnFamily, Dictionary<string, string> whereColumnValues);
        List<T> GetIndexes<T>(string columnFamily, Dictionary<string, string> whereColumnValues, int limit);
        List<T> GetIndexes<T>(string columnFamily, List<string> returnColumn, Dictionary<string, string> whereColumnValues);
        List<T> GetIndexes<T>(string columnFamily, List<string> returnColumn, Dictionary<string, string> whereColumnValues, int limit);

        List<T> GetIndexesAsObject<T>(string columnFamily, List<string> returnColumn,
            Dictionary<int, Dictionary<string, object>> whereClause, int limit, bool executeWithCLOne,
            bool executeWithCLLocalQuorum);
        ...
        List<T> ExecuteQueryToGetOriginalDataRows<T>(string columnFamily, List<string> requestColumn, Dictionary<int, Dictionary<string, object>> whereClause, int limit, bool executeWithCLOne = false, bool executeWithCLLocalQuorum = false, bool executeWithCLLocalOne = false);
    }
}
