...
namespace automation.components.data.v1.Redis
{
    ...
    /// </summary>
    public class StackExchangeRedisSentinelProvider : IRedisDataExplorer, IDisposable
    {
        ...
        private static Lazy<ConnectionMultiplexer> sentinelConnection =
            new Lazy<ConnectionMultiplexer>(() =>
            {
                ...
                if (string.IsNullOrEmpty(servers.Trim()))
                {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StackExchangeRedisSentinelProvider"/> class
        /// </summary>
        public StackExchangeRedisSentinelProvider()
        {
