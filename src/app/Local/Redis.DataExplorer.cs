using automation.components.data.v1.Redis;
...
namespace automation.components.data.v1.Local.Redis
{
    ...
    public class DataExplorer<T> : IDataExplorer<T>, IDisposable
    {
        ...
        public bool Add(automation.components.data.v1.Redis.DataExplorer<T>.Data data)
        {
            throw new NotImplementedException();
        }

        public bool Add(automation.components.data.v1.Redis.DataExplorer<T>.Data data, uint timeToLive)
        {
            throw new NotImplementedException();
        }

        public bool Add(List<automation.components.data.v1.Redis.DataExplorer<T>.Data> data)
        {
            throw new NotImplementedException();
        }

        public bool Add(List<automation.components.data.v1.Redis.DataExplorer<T>.Data> data, uint timeToLive)
        {
            throw new NotImplementedException();
        }
