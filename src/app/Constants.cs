...
namespace automation.core.components.data.v1
{
    internal static class Constants
    {
        ...
        #region RBA Retry Policy Constants
        public const string RBARetryPolicy = "rbaretry";
        public const string RBARetryPolicy_Ack = "rbaretry.ack";
        public const string RBARetryPolicy_Repl = "rbaretry.repl";
        public const string RBARetryPolicy_RequiredCount = "req.ctr";
        public const string RBARetryPolicy_ReceivedCount = "rec.ctr";
        public const string RBARetryPolicy_RetriesCount = "ret.ctr";
        public const string RBARetryPolicy_ConsistencyLevel = "conlev";
        #endregion
